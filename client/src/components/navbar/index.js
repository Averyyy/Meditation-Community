...
const user = {
  ...
  imageUrl:
    'https://pic1.zhimg.com/80/v2-bb99dd5f0546798861a6772a7e32fc93_1440w.jpg?source=1940ef5c'
  // 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
}
const navigation = [
  { name: 'Home', href: '/', current: false },
  { name: 'Medi Place', href: '/medi', current: false },
  { name: 'Scoreboard', href: '/scores', current: false },
  { name: 'Blog', href: '/blog', current: false },
  { name: 'About', href: '/about', current: false },
]
const userNavigation = [
  { name: 'Hello, '+localStorage.getItem('username'), click: '' },
  { name: 'Settings', click: '' },
